...
void EP1m::stepDebugPrint(double t, double dt)
{
    ...
    DebugMsg = QString("Пульт: %1 Ucc: %2 ВВК: %3 Uсн: %4 Реверс: %5 ГВ: %6 УК: %7 KT10: %8 KT1: %9 KV22: %10 KV15: %11 KM41: %12 KM42: %13 KM14: %14 K1: %15")
            ...
            .arg(static_cast<int>(km41->getContactState(0)))
            .arg(static_cast<int>(km14->getContactState(0)))
            .arg(static_cast<int>(k1->getContactState(0)));
}
