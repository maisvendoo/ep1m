    ...
    , indicationZapretOtpuska_(Q_NULLPTR)
{
    ...
    txtPaintPressureTM1_->setFonts(20, Qt::green, 87);
    ...
    txtPaintPressureTM2_->setFonts(20, Qt::green, 87);
    ...
    txtPaintPressureUR1_->setFonts(20, Qt::green, 87);
    ...
    txtPaintPressureUR2_->setFonts(20, Qt::green, 87);
    ...
    txtPaintAcceleration1_->setFonts(20, Qt::green, 87);
    ...
    indicationZapretOtpuska_->move(55, 434);
