...
//    manArrI_->move(434, 280);
    ...
    man21_ = new Manometer(manSize, "man21", 4, fon_, false);
    man21_->move(45, 232);
    man21_->addTxtLab1(QRect(135,162, 55,28));
    //man21_->setVal_zonaVIP(1.2);
    man21_->setVisible(true);

    man22_ = new Manometer(manSize, "man22", 1600, fon_, false);
    man22_->move(423, 232);
...
void MsudDisplay::slotUpdateTimer()
{
    ...
    input_signals[SIGNAL_MSUD_MODE] = 2;
